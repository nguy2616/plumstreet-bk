...
exports.SpecialDietsService = void 0;
...
let SpecialDietsService = class SpecialDietsService {
    constructor(specialDietsRepository) {
        this.specialDietsRepository = specialDietsRepository;
    }
    ...
    async update(id, updateSpecialDietDto) {
        const update = await this.specialDietsRepository.update(id, updateSpecialDietDto);
        if (update) {
...
SpecialDietsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(special_diet_entity_1.SpecialDiet)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], SpecialDietsService);
exports.SpecialDietsService = SpecialDietsService;
//# sourceMappingURL=special-diets.service.js.map